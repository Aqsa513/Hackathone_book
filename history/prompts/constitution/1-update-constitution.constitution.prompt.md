...
Updated the project constitution with concrete values based on the project context. The new constitution establishes core principles for the AI-Spec–Driven Book with Embedded RAG Chatbot project, including specification-first development, technical accuracy, clarity for professional developers, full reproducibility, disciplined AI-native authoring, and open source compliance.
